...
<body>
    ...
    <div id="wrapper">
        ...
        <?php //var_dump($_SESSION); // http://imagizer.imageshack.com/img921/8679/CVBuYL.jpg ?>
		<?php if($pageData['permission'] == 1) { // если это админ ?>
			<div class="row">
                <div class="col-lg-12">
    ...
    <!-- <script src="/mvc/cabinet/Assets/js/admin/users.js"></script> -->
   ...
   <!-- Metis Menu Plugin JavaScript -->
    ...
    <!-- <script src="/mvc/cabinet/Assets/js/admin/products.js"></script> -->
