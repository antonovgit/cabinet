...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" data-ng-controller="orderController">
            <?php // Если есть orderId и если он не пустой, а так же не пустой ключ orderInfo в масиве pageData, т.е. если есть информация о заказе и она не пустая, например http://cabinet/cabinet/orders?orderId=   ?>
            <?php //var_dump($pageData['orderInfo']); // http://imagizer.imageshack.com/img921/9006/hBzMFN.jpg ?>
